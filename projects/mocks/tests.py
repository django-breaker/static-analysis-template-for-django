...
class MocksViewIndexTest(SimpleTestCase):
    ...
    def test_create_view(self):
        response = self.client.post('/mocks', {'timestamp': 1602008716170, 'timezone': 'Asia/Seoul'}, format='json').json()
        ...
        response = self.client.post('/mocks', {'timestamp': 1602008716170, 'timezone': 'America/New York'}, format='json').json()
        ...
        response = self.client.post('/mocks', {'timestamp': 1602008749885, 'timezone': 'Asia/Riyadh'}, format='json').json()
